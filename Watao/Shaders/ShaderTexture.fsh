...
void main()
{
    ...
    //gl_FragColor = //specularOut
    //textureCube(textureCub,texCoordCub)*0.1+colorVarying*texture2D(texture1, texCoordOut)+specularOut;////colorVarying*texture2D(texture1, texCoordOut)+specularOut;
